...
/**
 * ConsumerSnapshotService is a service class that provides Kafka consumer functionality
 * for consuming sensor snapshots from Kafka topics.
 *
 ...
 * - Custom SensorsSnapshotDeserializer for value deserialization
...
public class ConsumerSnapshotService implements AutoCloseable {
    ...
    /**
     * Constructs a new ConsumerSnapshotService with the specified configuration.
     *
     * @param groupId the consumer group ID for snapshot events
