...
-- create scenario_conditions table linking scenario, sensor and condition for scenario activation
...
-- create scenario_actions table linking scenario, sensor and action to be performed when scenario is activated
...
-- create function to check that the scenario and sensor being linked work with the same hub
...
-- create trigger to check that the "condition" links correct scenario and sensor
...
-- create trigger to check that the "action" links correct scenario and sensor
